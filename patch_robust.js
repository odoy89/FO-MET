...
// 2. createEmptyRow
code = code.replace(/fotoUrl:\s*"",\s*status:\s*"Belum",/g,
  'fotoUrl: "",\n      fotoSegelKiri: null,\n      fotoSegelKiriUrl: "",\n      fotoSegelKanan: null,\n      fotoSegelKananUrl: "",\n      status: "Belum",'
);

// 3. handleEditRow
code = code.replace(/fotoUrl:\s*row\[14\]\s*\|\|\s*"",\s*foto:\s*null,\s*peruntukan:\s*row\[11\]/g,
...
code = code.replace(/let fileUrl = row\.fileUrl \|\| "";\s*let fotoUrl = row\.fotoUrl \|\| "";/g, 
...
code = code.replace(/fileUrl,\s*fotoUrl,\s*peruntukan/g, 'fileUrl,\n          fotoUrl,\n          fotoSegelKiriUrl,\n          fotoSegelKananUrl,\n          peruntukan');
...
code = code.replace(/r\[10\] \|\| "",\s*r\[12\] \|\| "",/g, 'r[10] || "",\n        r[14] || "",\n        r[15] || "",\n        r[16] || "",\n        r[12] || "",');

// 7. Data table headers and rendering
code = code.replace(/<th>Foto KWh<\/th>\s*<th>Status<\/th>/g, '<th>Foto KWh</th>\n                  <th>Foto Segel Kiri</th>\n                  <th>Foto Segel Kanan</th>\n                  <th>Status</th>');
...
// We will replace the original cell which is:
// <td>
// {typeof r[14] === "string" && r[14].startsWith("http") ? (
//   <a href="#!" onClick={(e) => { e.preventDefault(); handleShowImage(r[14]); }} className="text-primary text-decoration-underline" style={{ cursor: "pointer" }}>Lihat</a>
// ) : ("-")}
...
console.log("Success patching dashboard.js");
